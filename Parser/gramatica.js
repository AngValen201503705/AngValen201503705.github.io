...
import EjecFun from "../Instructions/EjecutarFun.js";
import Si from "../Instructions/Si.js";
...
function peg$parse(input, options) {
  ...
  var peg$f6 = function(val) {
  const loc = location()?.start;
   let Iins= InsIf;
   InsIf=[];
  return new Si(loc?.line, loc?.column, val, Iins);
};
  var peg$f7 = function(ini, fin, paso) {
  const loc = location()?.start;
   let Fins= InsFor;
   InsFor=[];
  ...
  var peg$f12 = function(type, id, params, inst) {
    const loc = location()?.start;
    let CInstr= InsFun;
    let CParm= ParamFun;
    InsFun=[];
  ...
  var peg$f13 = function(type, id) {ParamFun.push(new Symbol(id,null,type));};
  var peg$f14 = function(ins) {InsFun.push(ins);};
  var peg$f15 = function(ins) {InsFun.push(ins);};
  var peg$f16 = function(ins) {InsFun.push(ins);};
  var peg$f17 = function(ins) {InsFun.push(ins);};
  var peg$f18 = function(ins) {InsFun.push(ins);};
  var peg$f19 = function(ins) {InsFun.push(ins);};
  var peg$f20 = function(ins) {InsFun.push(ins);};
  var peg$f21 = function(ins) {InsFor.push(ins);};
  var peg$f22 = function(ins) {InsFor.push(ins);};
  var peg$f23 = function(ins) {InsFor.push(ins);};
  var peg$f24 = function(ins) {InsFor.push(ins);};
  var peg$f25 = function(ins) {InsFor.push(ins);};
  var peg$f26 = function(ins) {InsFun.push(ins);};
  var peg$f27 = function(ins) {InsFun.push(ins);};
  var peg$f28 = function(ins) {InsIf.push(ins);};
  var peg$f29 = function(ins) {InsIf.push(ins);};
  var peg$f30 = function(ins) {InsIf.push(ins);};
  var peg$f31 = function(ins) {InsIf.push(ins);};
  var peg$f32 = function(ins) {InsIf.push(ins);};
  var peg$f33 = function(ins) {InsIf.push(ins);};
  var peg$f34 = function(ins) {InsIf.push(ins);};
  var peg$f35 = function(ins) {InsWhile.push(ins);};
  var peg$f36 = function(ins) {InsWhile.push(ins);};
  var peg$f37 = function() {InsWhile.push(ins);};
  var peg$f38 = function(ins) {InsWhile.push(ins);};
  var peg$f39 = function(ins) {InsWhile.push(ins);};
  var peg$f40 = function(ins) {InsFun.push(ins);};
  var peg$f41 = function(ins) {InsFun.push(ins);};
  ...
  function peg$parseIntruccionIfSimple() {
    var s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13;
  ...
  function peg$parseinsEjecutarFuncion() {
  ...
  function peg$parseinstruccionf() {
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s0 === peg$FAILED) {
        s0 = peg$currPos;
        s1 = peg$parseIntruccionIfSimple();
        if (s1 !== peg$FAILED) {
          peg$savedPos = s0;
          s1 = peg$f16(s1);
        }
        ...
        if (s0 === peg$FAILED) {
          ...
          if (s0 === peg$FAILED) {
            ...
            if (s0 === peg$FAILED) {
              ...
              if (s0 === peg$FAILED) {
                s0 = peg$currPos;
                s1 = peg$parseinsEjecutarFuncion();
                if (s1 !== peg$FAILED) {
                  peg$savedPos = s0;
                  s1 = peg$f20(s1);
                }
